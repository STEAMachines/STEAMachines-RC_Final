...
@TeleOp(name="TeleOpSM_DECODE-Syauqi", group="STEAMachines_DECODE")
@Disabled
public class TeleOpSM_DECODE_Syauqi extends LinearOpMode {
...
//        displayWebcamVision();
        while(opModeIsActive()) {
            ...
            double drive2 = -gamepad1.left_trigger;
            double drive1 = gamepad1.right_trigger;
            double drive = (drive1 + drive2);
