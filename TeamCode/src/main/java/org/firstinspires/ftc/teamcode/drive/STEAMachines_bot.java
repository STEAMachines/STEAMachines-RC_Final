 ...
 */
@Config
public class STEAMachines_bot extends TankDrive {
    ...
    public STEAMachines_bot(HardwareMap hardwareMap) {
        ...
        leftMotors = Collections.singletonList(leftDrive);
        rightMotors = Collections.singletonList(rightDrive);
...
//        setLocalizer(new StandardTrackingWheelLocalizer(hardwareMap, new ArrayList<>(), new ArrayList<>()));
