...
@Disabled
@Autonomous(name="Autonomous4_DECODE_MeepMeep(Test)", group="STEAMachines_DECODE")
public class AutoDrive4_MeepMeep_1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        shooterMotors = hardwareMap.get(DcMotor.class, "launcherMotord");
